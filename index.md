...
本仓库收录 13 个 Agent Skills。每个目录保留自己的上游许可证和运行要求；使用前请阅读对应的 `SKILL.md`。
...
| [`humanizer`](humanizer/) | 识别并减少文本中的 AI 写作痕迹 | Clawic v2.1.1 |
| [`prototype-html`](prototype-html/) | 生成带交互和说明的单文件 HTML 产品原型 | 内部 v1.0.0 |
